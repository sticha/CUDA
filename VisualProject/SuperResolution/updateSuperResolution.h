...
__global__ void super_updateU(float * d_u1, float * d_u2, float * d_r, cudaTextureObject_t d_p1, cudaTextureObject_t d_p2, float2 * d_q1, float2 * d_q2, float * d_v1, float * d_v2, float gamma, int w, int h);
