...
__global__ void super_updateP(float * d_p, float * d_f, float sigma, int w, int h);
__global__ void super_updateQ(float2 * d_q, float * d_u, float sigma, float beta, int w, int h);
__global__ void super_updateR(float * d_r, float * d_u1, float * d_u2, float * d_v1, float * d_v2, float sigma, float beta, int w, int h);
